...
const ChooseHome = () => {
  return (
    <div className="bg-[#fcf5ff] font-poppins lg:px-24 px-5 lg:py-[124px] py-20">
      <div className="max-container">
        <h2 className="text-[#ff7834] lg:text-[48px] text-[40px] font-semibold lg:text-center">
          Why <br className="block lg:hidden" /> Choose Us
        </h2>
        <div className="lg:mt-[30px] mt-[50px] grid gap-10  grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
          <div className="space-y-3 bg-[#006e99] p-8 rounded-[4px] text-center   text-white">
            <img
              src={Choose1}
              alt=""
              className="w-[56px] lg:w-[64px] mx-auto"
            />
            <h3 className="font-semibold text-xl lg:text-[24px]">
